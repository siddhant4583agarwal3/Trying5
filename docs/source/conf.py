...
sys.path.insert(0, os.path.abspath("../../Trying5"))
...
# documentation.
html_theme_options = {
    "github_url": "https://github.com/siddhant4583agarwal3/Trying5",
    "repository_url": "https://github.com/siddhant4583agarwal3/Trying5",
